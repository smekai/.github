...
| Product | 1× PNG | 2× PNG |
|---|---|---|
| SMEKAI | [`smek_ai_icon_graphite_smek_ai.png`](identity/smek_ai_icon_graphite_smek_ai.png) | [`smek_ai_icon_graphite_smek_ai@2x.png`](identity/smek_ai_icon_graphite_smek_ai@2x.png) |
...
| Isotopy | [`smek_ai_icon_graphite_isotopy.png`](identity/smek_ai_icon_graphite_isotopy.png) | [`smek_ai_icon_graphite_isotopy@2x.png`](identity/smek_ai_icon_graphite_isotopy@2x.png) |
...
SMEKAI avatar. Upload it under the organization profile settings when the
